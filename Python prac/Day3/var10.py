...
if environment == "production" and region == "us-east":
   ...
   replicas = 1
#Final output format:
print(f"Deploying {app_name} version 3.0.0 with {replicas} replicas in {environment} environment (region: {region}). Debug: {is_debug_mode}")
